...
public class Entity0
{
    ...
    public Entity0(double x, double y, double yPos, double speed, boolean dest, boolean pick, boolean alive, String img)
    {
        this.x = x;
        this.y = y;
...
/*
    ...
    public void move()
    {
        ...
        /*List<Entity0> entities = World.getInstance().getEntities();
        for (Entity0 o : entities)
        {
            if (!o.isDestroyable() || o.isDead()) continue;
